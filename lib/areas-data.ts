    ...
    subcategories: [
      ...
      },
      {
        ...
        products: [
          ...
          { id: 'fp4', name: 'Flow: The Psychology of Optimal Experience', type: 'book', description: "Mihaly Csikszentmihalyi's landmark work on the mental state of complete absorption in an activity — the foundational psychology behind what it truly means to focus deeply.", price: '$17.99', affiliateUrl: 'https://www.amazon.com/Flow-Psychology-Experience-Perennial-Classics/dp/0061339202?crid=3NJ3IINYO26BQ&dib=eyJ2IjoiMSJ9.8LgxVQKVvjSH9WH6HdepR_LEiXg5eG8Uiie5luxClNUerscyuYpza0bzB0x3Aedg7uMY1Puf21H_ZJAcNJHI0vuMluJy0o6PK3ssZ_rFgi9CAq4l4hptR50UUouU6EL0ZbiBp1w9EIp-kr9oJzOujf1CyZal9-Z_E4osWNNsZ72cj3ROphySc38jAaz5WQr2eI8IM8EXpeKwVtR0uHTOFRNXdPun1F51Ov4njTMCmpk.2FLhXxqKPQMUSfiDXmK3BzGT04mAhlOey5MWuN9BNBA&dib_tag=se&keywords=Flow%3A+The+Psychology+of+Optimal+Experience+by+Mihaly+Csikszentmihalyi&nsdOptOutParam=true&qid=1789667363&sprefix=flow+the+psychology+of+optimal+experience+by+mihaly+csikszentmihalyi+%2Caps%2C223&sr=8-1&linkCode=ll2&tag=radiantlifeba-20&linkId=637c0e1c648de5e92520d6dfc4064c74&language=en_US&gaOptInStatus=true&ref_=as_li_ss_tl', rating: 4.7 },
        ],
      },
      {
        id: 'creativity',
    ...
    subcategories: [
      {
        ...
        products: [
          ...
          { id: 'slp2', name: 'Magnesium Glycinate Sleep Support (400mg)', type: 'supplement', description: 'Highly bioavailable magnesium glycinate supports deep, restorative sleep by calming the nervous system — without the grogginess of traditional sleeping aids.', price: '$24.99', affiliateUrl: 'https://www.amazon.com/Magnesium-Relaxation-Melatonin-Free-Supplement-Magnesium-Glycinate/dp/B0FDM7LF8P?crid=3P3G5LHVUZA9&dib=eyJ2IjoiMSJ9.mrUslH086JnqtFxcdw9XGh10yUrTNX2UO-sDp60Q0-NlmBCt2loi2yHPFznhKyOpSyc9tf1kdKI_c14SweHa8qbs-beHAqC2i8JuGMJAsq-J20pbV67TUBdKAGRGbtvMlyocRTb0WuPn9guW7ffbCNAwDyy1Bia73aPp0ZFyJCx152VuADQ6BLKrdnVS2zit7s_NUNhU89qyuJhpSeLoyIoUQGt8TX9CdmbNnfj_DBLp8EzfQCr5p-QmBFZaDeUBd7P5cOfJRqj1J5bMT3-hJjbWfUgCkl9oML2L-J-SBnI.wQ_UVErE99ip-sLv3cjZJbYauHdcvMDORhsxnzCNPFE&dib_tag=se&keywords=Magnesium+Glycinate+Sleep+Support&qid=1789397682&rdc=1&sprefix=magnesium+glycinate+sleep+support%2Caps%2C312&sr=8-4-spons&sp_csd=d2lkZ2V0TmFtZT1zcF9hdGY&psc=1&linkCode=ll2&tag=radiantlifeba-20&linkId=42137a3e5e0eae7b4051643e321d413d&language=en_US&gaOptInStatus=true&ref_=as_li_ss_tl', rating: 4.6 },
          { id: 'slp3', name: 'Manta Sleep Mask Pro', type: 'physical', description: '100% blackout sleep mask with contoured, adjustable eye cups that block all light for dramatically deeper sleep anywhere, any time.', price: '$39.99', affiliateUrl: 'https://www.amazon.com/Manta-Sleep-Mask-Adjustable-Deepest-Possible/dp/B07PRG2CQY?crid=16AB9FXKQCCTT&dib=eyJ2IjoiMSJ9.BcNR1JnCvq0xidcKT_vDoj5cE_Lreym2URf8DPqOPcbbDLJ_7ojP42wuUjY7-M0_werqbL2JUlrNpUGsKyU9vyma7ng_JsE4kSrdqyNxgeN6_qx0VKKNtZx5_rKKUCDQJ1neDLppQfpnIcRraNmRqgTdn497pUvh6aOkyZ2zf9dTEK46pFmAtFPnBgxvr4zOoH5WscLo1Y4Ly1zNgmuVNDar9qeHb5dhmiE6GHw-JHR1gvJkXorAHvYA1aB1kzp0ireGyu0BiKkMlEBNHFafCDJn0NafLZjZmma0E3WRDiQ._aosTRHRxQBOaHsODVbXXarh0r-xubtELV4AzYpe93w&dib_tag=se&keywords=Manta%2BSleep%2BMask%2BPro&qid=1789397788&sprefix=manta%2Bsleep%2Bmask%2Bpro%2Caps%2C693&sr=8-2-spons&sp_csd=d2lkZ2V0TmFtZT1zcF9hdGY&th=1&linkCode=ll2&tag=radiantlifeba-20&linkId=b2cbefb58cd29450ff426c4b96701bac&language=en_US&gaOptInStatus=true&ref_=as_li_ss_tl', rating: 4.5 },
        ],
      },
      {
        id: 'nutrition',
        ...
        products: [
          ...
          { id: 'ntp2', name: 'Athletic Greens AG1 — Daily Health Drink', type: 'supplement', description: 'The comprehensive all-in-one daily drink with 75 vitamins, minerals, and whole food-sourced ingredients for foundational nutrition and energy.', price: '$79.00/month', affiliateUrl: 'https://www.amazon.com/AG1-Greens-Nutrition-Formula-30-Servings/dp/B0FBXZF3MD?crid=2IW0FJ2ZW0R1Z&dib=eyJ2IjoiMSJ9.FRSGxLkrmRPArpoknKjr5XSZOVy3OhOi2RT9rjMxpKflrPAdgBHDbcUt5fAERO1x9Xii8gBMHU7ImwtF0E694enM9TwzKutcEJejIC448a6102wu-_ug8meyrunPRDg0xRWdOUWfwHl-1aMFUhuw2g0GQ5Np7iNf_pmTGVLtj4d97rurgWaqWZO8JaRgfY2XH-YgyonfI8Xe06TsZ22-y142R4BGBcQsK2mKTKzqKjnn1pcNyzhjqt-6hGkK9iSPnpZpQSw5HCCUDOUqrV19KO8wzSYQ0WILuAVIp-C8Nls.5t6Gfj8ivCtWnq0T-pNaaBpXl82fflD9gqVKSV4pPFs&dib_tag=se&keywords=Athletic%2BGreens%2BAG1&qid=1789397861&sprefix=athletic%2Bgreens%2Bag1%2Caps%2C191&sr=8-3-spons&sp_csd=d2lkZ2V0TmFtZT1zcF9hdGY&th=1&linkCode=ll2&tag=radiantlifeba-20&linkId=43bca5d9cbd7d645dba946e1381bf065&language=en_US&gaOptInStatus=true&ref_=as_li_ss_tl', rating: 4.4 },
          { id: 'ntp3', name: 'Omega-3 Fish Oil (Triple Strength)', type: 'supplement', description: 'High-potency EPA/DHA omega-3s for brain health, heart health, reduced inflammation, and improved mood — the most universally recommended supplement.', price: '$34.99', affiliateUrl: 'https://www.amazon.com/NOW-Supplements-Molecularly-Distilled-Cardiovascular/dp/B001GCU6KA?crid=P1EX99WQG22V&dib=eyJ2IjoiMSJ9.pvo-ibsG3i79XioKNbz0UZUChzC10W5sDvrMzEJotuWP7H521mvxOon3q2CBZUUppt081gDXmP3V5la3-L2NGri91zZwOQyO1Je3FsFgy8fxhx0X_nqwRGA2Wn2kkyQB3CxiM0HS0xKBjH0KIwdL-f8wsqdMSTaE5keBoNg5u7dwxUyR4XOTmtUkRJJvLlQwijLHf_D5jsU2YaTQOnjd8t_ZqW0X1zAOLXHwItZOt7HGCpoM4u7JbkSZbD1lFmD6JxXXkznV6nXrP9oZBNGdS4nOUxYrGee1s4FkUskhz-c.LihEzNeAcwKTBt6tY05x1-1sCZqN8mumf0kZUfcOOrM&dib_tag=se&keywords=Omega-3+Fish+Oil+mercury+free&qid=1789398048&sprefix=omega-3+fish+oil+mercury+fre%2Caps%2C187&sr=8-1&linkCode=ll2&tag=radiantlifeba-20&linkId=f05f1f39653f375fbe433aca8c36e462&language=en_US&gaOptInStatus=true&ref_=as_li_ss_tl', rating: 4.7 },
        ],
      },
      {
        id: 'exercise',
      ...
      },
      {
        ...
        products: [
          ...
          { id: 'wtp2', name: 'Glucomannan Appetite Control (Konjac Fiber)', type: 'supplement', description: 'Clinically proven natural fiber supplement that expands in the stomach to promote satiety and reduce caloric intake without hunger or deprivation.', price: '$21.99', affiliateUrl: 'https://www.amazon.com/Carlyle-Glucomannan-Capsules-Soluble-Supplement/dp/B08VNFSJKP?crid=13S22BERZWC51&dib=eyJ2IjoiMSJ9.NstuTjqrILgiN1dODvTZ73YWcZmOvr7Aw1YZn0Bz05yIlR61N-R6fbiOvIzBGnMqMlsE2gHnEpAfbLNCE92trKgpeFAY_rUL-VK6RRfdYI_Ye9jI-VeOAEUQ0XR82TgLoaR-aRCLTPC41Y8g--8R3KKdAxJv_QbSMlQ9Fqv8wALteeydFDf0vdAZkbTfxjhy1BmzC98-kaFR0aGN2Wb3D1RmRxJ2QFVCw-nQ_MdrRZDVjpxJ1qimXZs0iKbb7Oc03npEYBcn1wTk7eZc8UMn47ATG-YHVuhuVuntVvNPUKQ.L-GgwAqCE-JCU9DLqerJS1_SFPaX5ROYmi087BYCHPw&dib_tag=se&keywords=Glucomannan+Appetite+Control&qid=1789398541&s=hpc&sprefix=glucomannan+appetite+control%2Chpc%2C793&sr=1-4&linkCode=ll2&tag=radiantlifeba-20&linkId=f792cb4c4b35f28876c8c7681ccf405d&language=en_US&gaOptInStatus=true&ref_=as_li_ss_tl', rating: 4.2 },
        ],
      },
      {
        id: 'energy',
        ...
        products: [
          { id: 'enp1', name: 'CoQ10 + PQQ Advanced Energy Complex', type: 'supplement', description: 'Advanced mitochondrial support formula combining CoQ10 and PQQ for sustained cellular energy production, mental clarity, and cardiovascular protection.', price: '$34.99', affiliateUrl: 'https://www.amazon.com/Morgan-Pyrroloquinoline-Quinone-CoQ10-100mg/dp/B0FSTG613F?crid=3X6MV142HSSN&dib=eyJ2IjoiMSJ9.h4R-oyvVUTB-a0Z-lgbRARNNxuoxZHakTZiZXWL3wok0U6coA9dmSky5a6Skc6tvOiz5Z80S7Wk1gD-iGYOiy2-5M9mVFUAg1381ImhQRtRLtmIQ5--Ws5hwFQNkEWhBhjqqexYPI73-zVKvYkbbtHDzPZ4fVDdtbho6ALvlm_HrxeAf-DcDFYQhoLCDnk2FJ3DeutY7v7QmMYGztbs62wI_3osr5WZyRD2SGLuQPjut3kvtdST5zWC1kT6IGsaD4MXUln8lGuuY3JxZJ6Fnz0fBvLbqgnQmAADaNAgJIUM.K-k8H68y5Q9pOprt6kKTTMw3eKXPFQl1dmzzoTodW80&dib_tag=se&keywords=CoQ10+%2B+PQQ+Advanced+Energy+Complex&qid=1789398689&s=hpc&sprefix=coq10+%2B+pqq+advanced+energy+complex%2Chpc%2C424&sr=1-30&linkCode=ll2&tag=radiantlifeba-20&linkId=b15dcbbf583057b2ec5c74214b32e28d&language=en_US&gaOptInStatus=true&ref_=as_li_ss_tl', rating: 4.4 },
  ...
  spirit: {
    ...
    subcategories: [
      ...
      },
      {
        ...
        products: [
          { id: 'happ1', name: 'The Happiness Advantage', type: 'book', description: "Shawn Achor's research-backed guide to how a positive brain fuels success in work and life — and the seven principles that activate happiness as a competitive edge.", price: '$16.99', affiliateUrl: 'https://www.amazon.com/Happiness-Advantage-Positive-Brain-Success/dp/0307591557?crid=IGTJFJWIKXV2&dib=eyJ2IjoiMSJ9.FoibafxNHjFUA4nIzwnHLaG6WYAdaWXU9UojuWSnZKgrqV_-MiN7G-sG2Lh_8IlItzsbrSubFme5HNuWI-hvFweruHut1q14Y9jOHV50ynlRhc9wgN9oreaxnwSgrLoZ71uipqduDp66nuHkgUzuMVovc57-7uw8UwidfV025rvJT6k3bwwiGKZcNk_NTQuUkKzoG0bPxkbgLIOWbdCH2b_-YhzS6G7DL2GDjvDmdLs.2iBHqrR-jZGf1Hn4dka_LVecN62GKMGyRdV2aPEGnmU&dib_tag=se&keywords=happiness+advantage&qid=1789363619&sprefix=happiness+advantage%2Caps%2C168&sr=8-1&linkCode=ll2&tag=radiantlifeba-20&linkId=6c37d7e1134f096d06a385e268510da2&language=en_US&gaOptInStatus=true&ref_=as_li_ss_tl', rating: 4.7 },
          { id: 'happ2', name: 'The Art of Happiness', type: 'book', description: 'The Dalai Lama and psychiatrist Howard Cutler explore the foundations of enduring happiness — blending ancient wisdom with modern psychology in a timeless conversation.', price: '$15.99', affiliateUrl: 'https://www.amazon.com/Art-Happiness-Handbook-Living/dp/1573227544?crid=1HLX6GGTRQHLN&dib=eyJ2IjoiMSJ9.K3-JZInF1v8nkez3pULwHdXdvTZyznPZKCGh2xt3seByBPwf_UZdWNTM5rmv9UaPz2wRgfVLdBI_vlCwO7Z1DbDZJ3KFcPIJAOW9Wd9Ai0bw-Zij_CfAtlajd1DQ40lz_PGFU9Xp25kUHwiQsl--7U2C1vAFhLOOengvPKB-vfC3u1bkW970DXA45g6GMA7_UoH8z3HBHO8lfkHOtMlM4Q-lmwxwtUV9faYUD_sixtM.Fu_rYe2peBCclMmIAuxCYJH-adZFdIfG2EruBG98Bw8&dib_tag=se&keywords=Art+of+Happiness&qid=1789363675&sprefix=art+of+happiness%2Caps%2C520&sr=8-1&linkCode=ll2&tag=radiantlifeba-20&linkId=0d582d7d700580ae0732c72230974800&language=en_US&gaOptInStatus=true&ref_=as_li_ss_tl', rating: 4.7 },
          { id: 'happ3', name: 'The Happiness Project', type: 'book', description: "Gretchen Rubin's memoir chronicling one year spent test-driving the wisdom of the ages, current science, and the lessons from popular culture about how to be happier — practical and deeply relatable.", price: '$17.99', affiliateUrl: 'https://www.amazon.com/Happiness-Project-Tenth-Anniversary-Aristotle/dp/0062888749?crid=37MN9T5CZRQ70&dib=eyJ2IjoiMSJ9.fbto79p9_bUV7z6uc6cbGzf6Ic2Gp0WKyWjL2V4KMmGYhrY7znvBlTJE1GSrigcLmouFPbMK2P7pnH1_Fo7vFM1FpDifzzh67JQGSYl2TqLC2NsuPre4PW3jAbbkowv1OUNyAUqX9QDCyquGHv-GZGdHWgcB4Gg_1PGvFcA7gwEidt55fhgzsnXv_3HGX7XUX84hyXYkKVhcATBrTY4yUOS7HFUQvGUWlEWujsLBLMs.xaYtW6BCW7474QlO8RUs5-SIu8HFXjsk3n25zJL5iDk&dib_tag=se&keywords=Happiness+project+rubin&qid=1789363758&sprefix=happiness+project+rubin%2Caps%2C191&sr=8-1&linkCode=ll2&tag=radiantlifeba-20&linkId=e4bcba8c1e1b113b5c257336e33c5c41&language=en_US&gaOptInStatus=true&ref_=as_li_ss_tl', rating: 4.6 },
        ],
      },
      {
        id: 'gratitude',
  ...
  relationships: {
    ...
    subcategories: [
      ...
      },
      {
        ...
        products: [
          { id: 'famp1', name: 'The Whole-Brain Child: 12 Revolutionary Strategies to Nurture Your Child\'s Developing Mind', type: 'book', description: "Daniel Siegel and Tina Payne Bryson's neuroscience-based approach to raising emotionally intelligent, resilient children while strengthening your relationship.", price: '$15.99', affiliateUrl: 'https://www.amazon.com/Whole-Brain-Child-Revolutionary-Strategies-Developing/dp/0553386697?crid=6N46QDP7EHD5&dib=eyJ2IjoiMSJ9.yY32tNjfX0fgP4Ww5DSgQ977bNI9Ph-S_-0_zssRft63JtUo7trZDXMQjM_NpvsFShQ5ASfZ0o53DD8FJrWgGNkc8SL7F_TrZEdDabJ8P83t0GikCOYoMfa6DpP1uLDY6EzxWhIFGH6OR_yyoggkIru9jojzvQsu8vcS8LCsji4IEuey5B5UkwsbTgTJsvURscpXJMGiJ7O0LZKMOD6YMXxpbnTH3QNPX79DHlc9lYs.dK_3lRexor1FbrBAhCJJLviVaVNVhkKmJ0ifVlADcmU&dib_tag=se&keywords=The+Whole-Brain+Child&qid=1789413286&sprefix=the+whole-brain+child%2Caps%2C189&sr=8-1&linkCode=ll2&tag=radiantlifeba-20&linkId=b137e065dd8001ef075d4cf1374668e4&language=en_US&gaOptInStatus=true&ref_=as_li_ss_tl', rating: 4.7 },
      ...
      },
      {
        ...
        products: [
          { id: 'comp1', name: 'Crucial Conversations: Tools for Talking When Stakes Are High', type: 'book', description: 'The definitive guide to high-stakes conversations — how to speak persuasively and caringly about topics that matter most, rather than avoiding them or escalating.', price: '$17.99', affiliateUrl: 'https://www.amazon.com/Crucial-Conversations-Third-Talking-Stakes/dp/B09MV3818X?crid=HGJKJ0J1TJ6V&dib=eyJ2IjoiMSJ9.VufgGWf1JuxUe2Xlnt-x6L4jf2KeyK3wOOyuNhQPjVAVNlf-kR3qXiotekkn4NKBIX1ZC7Hyq9AhOhZ4RgJzK0EsJPXUQHuk8QNa5qjcFL1otCdlXBJ409Kmggfziyo4wLTPoCjHGyV4lp6J-jQidyhWL9DWF4BW4OIIo9A2BqSadhCIsZ74wVra_q_iCeL6oPtuU2VsSJebC0ijNibTcqGxsarAGEnXDyI7ttSaZBA.WZimYlVP0A2auFSY8iZbYbc9JDDDXovgO_Zl3ZGlrWQ&dib_tag=se&keywords=Crucial+Conversations&qid=1789413437&sprefix=crucial+conversations%2Caps%2C193&sr=8-1&linkCode=ll2&tag=radiantlifeba-20&linkId=780137b114fa07e77f34c4c62a2eaf48&language=en_US&gaOptInStatus=true&ref_=as_li_ss_tl', rating: 4.7 },
  ...
  money: {
    ...
    subcategories: [
      ...
      },
      {
        ...
        products: [
          { id: 'budp1', name: 'You Need a Budget: The Proven System for Breaking the Paycheck-to-Paycheck Cycle', type: 'book', description: "Jesse Mecham's book distilling the YNAB methodology — four simple rules that help you gain control of your money, stop living paycheck to paycheck, and build real savings.", price: '$16.99', affiliateUrl: 'https://www.amazon.com/You-Need-Budget-Paycheck-Paycheck/dp/0062567586?_encoding=UTF8&dib_tag=se&dib=eyJ2IjoiMSJ9.eelW_nEkiAZUdJ5eiUekR_Kx-xu387h1GTM96mMyeGS0DMLoNO5mhRtNn_suIxjwGjCHx-UhtHalcvtJWtB6D8ef6eREb5lMNILrdqliyPdzPGIuuSfDtXEeyvUO8ToNgtpNFOwLvwA_BKITcFINW4LEwoCX_wZSJ0aC-L6Qdnid6XkJU-qdDamwnPQQctDtevHMNg16UUSTPOFur-SoXTDxh_ljVIkkwo4cWDlesoU.nLa73qALwnM5eeQkqfTX13ZifAfCb0lBT-lqNmC33Rg&qid=1789456525&sr=1-5&linkCode=ll2&tag=radiantlifeba-20&linkId=678f8ee8514948ce9bc53b8c9824dc51&language=en_US&gaOptInStatus=true&ref_=as_li_ss_tl', rating: 4.7 },
  ...
  direction: {
    ...
    subcategories: [
      ...
      },
      {
        ...
        products: [
          { id: 'lvp1', name: 'Designing Your Life: How to Build a Well-Lived, Joyful Life', type: 'book', description: "Stanford professors Bill Burnett and Dave Evans apply design thinking principles to the challenge of building a deeply meaningful, uniquely yours life.", price: '$17.99', affiliateUrl: 'https://www.amazon.com/s?k=Designing+Your+Life&crid=1M0N3LHCU1SY0&sprefix=designing+your+life%2Caps%2C445&linkCode=ll2&tag=radiantlifeba-20&linkId=2385bba438a3d6ce25d8ddee6a4d5632&language=en_US&ref_=as_li_ss_tl', rating: 4.5 },
          { id: 'lvp2', name: 'Best Self Journal', type: 'physical', description: 'A 13-week guided journal for creating your vision, setting meaningful goals, and building the daily practices that transform your life systematically.', price: '$32.99', affiliateUrl: 'https://www.amazon.com/BestSelf-Self-Journal-Mist-Productivity/dp/B0BR8KRXFZ?crid=TAF27N7CT6B2&dib=eyJ2IjoiMSJ9.hZoG2iwM3XPrRrvSxplLjrZkHd0WBE-GlYoHXCtkjYCqqGXvdYrEiAPH5Zb-MY2Ipvf4N_AAsSsBBESv43CRNNNgfKxgRTXay4qw534oZxHgBb-quozFQRySCBHU-LV9PIDQaum5wdmptTPZvnJuvwe3aZczvAk0g_nzHL1WAEGKOzHHDHOmQGrMgvw6VzgnUD5iks-JhQPVRX32WPjjsspH_AdFaFJ-0FKPgHo3NaJFJokz2x1eR8EQBgycSxxPGngKPC06RyB7U8TJMm_L2VjaA3vIT2HQlLqiH_89aPA.WdHpvctnCC4g8-_GlxtNPF55KccLyNpQP5ZgVQ8-_p8&dib_tag=se&keywords=Best%2BSelf%2BJournal&qid=1789364521&sprefix=best%2Bself%2Bjournal%2Caps%2C318&sr=8-1-spons&sp_csd=d2lkZ2V0TmFtZT1zcF9hdGY&th=1&linkCode=ll2&tag=radiantlifeba-20&linkId=dca656b4c2beafd98dd429284137163c&language=en_US&gaOptInStatus=true&ref_=as_li_ss_tl', rating: 4.6 },
          { id: 'lvp3', name: 'The Purpose Driven Life', type: 'book', description: "Rick Warren's bestselling exploration of finding meaning and direction through a life oriented around purpose greater than yourself — a foundational read on living intentionally.", price: '$16.99', affiliateUrl: 'https://amzn.to/4bYtTvi', rating: 4.7 },
          { id: 'lvp4', name: 'The Passion Test: The Effortless Path to Discovering Your Life Purpose', type: 'book', description: "Janet and Chris Attwood's simple yet powerful process for identifying what matters most to you and aligning your life around your true passions.", price: '$16.99', affiliateUrl: 'https://amzn.to/3TTV983', rating: 4.5 },
          { id: 'lvp5', name: 'The Meaning of Your Life', type: 'book', description: "A guided exploration into discovering deep, lasting purpose — helping you connect daily actions to a larger sense of meaning and direction.", price: '$15.99', affiliateUrl: 'https://amzn.to/4fm84rO', rating: 4.4 },
        ],
      },
      {
        id: 'time-management',
      ...
      },
      {
        ...
        products: [
          { id: 'cgp1', name: "So Good They Can't Ignore You: Why Skills Trump Passion", type: 'book', description: "Cal Newport's counterintuitive guide to building a fulfilling career by developing rare and valuable skills — the approach that actually works, backed by real examples.", price: '$16.99', affiliateUrl: 'https://www.amazon.com/Good-They-Cant-Ignore-You/dp/1455509124?crid=2EV1MT5IEVYJ&dib=eyJ2IjoiMSJ9.e5Mbq5W_Spp7a6DbB-qpBHb30tEDgBGBZHPesmjUzjxZcsiIgj2Jnh58o-Ujuw9YZPuNNtw8f9eYPuK6IF6lg9s-TgUTSg7zReTef8QDod3DacUHiNJ7FHLAWCzJbKCI_FzylMe5eG2rTHJ3C6Qdvx4dP2fqyccdeVZfaMxz21EeLAGLs5g9TLIHjhhA5KJY1LezBkG5kE5Q2OFh4-t14VHwcdHecgcR2UaMQAB3FyauFA77vq913rSKlT2dd6jX9PbSPxHoRBXLHaDK9v7w2DwpaQBAbsK3i6YkAsnYVKM.-ZMqy7JkRBb6pXsHeVfWOuBobtqbEcGsqfDz_EOLlwk&dib_tag=se&keywords=so+good+they+can%27t+ignore+you&qid=1789666956&sprefix=so+good+they+can%27t+ignore+you%2Caps%2C169&sr=8-1&linkCode=ll2&tag=radiantlifeba-20&linkId=c42f98db06b6d35a281fb8d010e1f318&language=en_US&gaOptInStatus=true&ref_=as_li_ss_tl', rating: 4.6 },
